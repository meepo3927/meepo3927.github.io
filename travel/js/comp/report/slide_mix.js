...
methods.commonRequest3 = function (url, o = {}, m) {
    ...
    return Request.getActionJSON('/async/' + url, p, m);
};
...
methods.getSinglePieOption = function (o) {
    let title = {
        top: 55,
        left: 'center',
        textStyle: {
...
methods.getAverageAndMax = function (data) {
    var maxItem = null;
    var total = 0;
