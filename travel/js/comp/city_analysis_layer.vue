...
export default {
	...
	destroyed,
	components: {
		'part-1': require('comp/city_analysis_part_1.vue'),
		'part-2': require('comp/city_analysis_part_2.vue'),
		'part-3': require('comp/city_analysis_part_3.vue'),
		'part-4': require('comp/city_analysis_part_4.vue'),
