...
<div class="six-part six-part-2 inner-main">
    ...
    <div class="main-section mt15">
        <div class="six-intro-text" >为各行业提供基于移动大数据的客户特征洞察与客户细分。通过整合传统电信数据和行业相关数据，挖掘用户身份特征、消费价值特征、社交行为特征、地理位置特征等，构建行业客户细分群，从客户的基本属性、行为、偏好、心理、价值、满意度等角度进行客户细分，清晰描绘出客户全息精准画像，并通过标签输出或分析支撑等形式为各行业客户洞察和精准营销提供全方位的支撑。
        </div>
        <!-- 地图 -->
