(function (window, document, undefined) {
	...
	var IE = getIEVersion();
	var staticVersion = global.version  || '1.0';
	...
	var loadCommon = function () {
		var file = '/dist/commons.js?v=' + staticVersion;
		loadJS(getBasePath() + file, loadEntry);
	};
	var loadEntry = function () {
		...
		loadJS(getBasePath() + file + '?v=' + staticVersion);
	};
	window.LOG = function () {
	...
	if (IE && IE <= 8) {
		loadJS(getBasePath() + '/js/ie8Overlay.js');
	} else {
		loadCommon();
	}
})(window, document);